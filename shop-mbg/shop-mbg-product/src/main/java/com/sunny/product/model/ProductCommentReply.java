...
public class ProductCommentReply implements Serializable {
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "被回复的product_comment的id")
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "回复ID，默认为0")
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "是否官方回复,0否(非官方回复),1是(官方回复)")
